===  MetaboxUI for OptionTree ===

Contributors: Rajilesh Panoli
...
This plugin is used for Create and manage Wordpress Widgets, Metaboxes, Taxonomny Custom Fields, User Profile Fields.
Only for OptionTree users
...
MetaboxUI can manage custom meta boxes, usermeta boxes, taxonomy metaboxes from admin side as simple as kissing. You can simply manage all custom field settings there. Now you can also specify custom fields for specific template files

Now you can create or manage wordpress widgets easily on the fly using Widget Metaboxes UI



This is compatible with OptionTree 2.4.6 or greater
...
*   This plugin uses eval function to create widgets. So Please be careful while sharing admin password to others.
