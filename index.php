...
include_once('includes/dynamic_widget.php');
...
echo '<p>' . __( '
 ...
 // Shortcodes
    ...
    // Shortcodes
      echo '<p>&nbsp; </p>'; echo '<p>&nbsp; </p>';
		 echo '<h4>'. __( 'Using Widget Metabox', 'rj-option-tree' ) . '</h4>';  echo '<p>' . __( '
			<code> 
         <pre>
         // Lets create a simple widget now!
         //Example sample code to design your widget
         function your_widget_display_hook($args,$instance){
            ...
            echo $after_widget;
                ...
                add_action("wp_widget_design_{your_widget_id}","your_widget_display_hook",10,2);
                
                // Thats all!
                // Happy editing...
                // replace {your_widget_id} with your widget id
                // After that copy and paste this code into your functions or plugins file.
                </pre></code></pre>
		', 'option-tree' ) . '</p>';
