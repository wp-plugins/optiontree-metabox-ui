...
function ot_array($var){
 ...
 function ot_user_meta_attachment($var,$echo='',$size='full'){	
 ...
 function ot_user_meta_attachment_by_uid($id,$var,$echo='',$size='full'){	
...
function ot_user_attachment($var,$echo='',$size='full'){	
...
function ot_user_attachment_by_uid($id,$var,$echo='',$size='full'){	
...
function ot_user_meta_attachment_by_id($var,$echo='',$defaultVal='',$size='full'){
...
function ot_user_meta($var,$echo=''){
	global $post;
	return ot_user_meta_by_uid($post->post_author,$var,$echo='');
