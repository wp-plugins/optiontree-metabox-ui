            ...
            class ' . $widget_class_name . ' extends WP_Widget {
               ...
               if(!empty($fields)){
                  ...
                  $field_keys[$key] = $this->get_field_name($key);
                    ...
                    RJ_OT_Widget_Meta_Box::build_widget_meta_box("asd",$this->widget_datas,$instance,$field_data,$field_keys);
...
echo \$after_widget;
                ...
                add_action(\"wp_widget_design_'.$widget_data['id'].'\",\"your_widget_display_hook\",10,2);
