       ...
       if(!class_exists("' . $widget_class_name . '")){
            class ' . $widget_class_name . ' extends WP_Widget {
               ...
               if(!empty($fields)){
                ...
                function wp_widget_display_hook_'.$widget_data['id'].'(\$args,\$instance){
...
echo \"&lt;h1&gt;\$title&lt;/h1&gt;\";
echo \"&lt;p&gt;This is my new widget!&lt;/p&gt;\";

echo \$after_widget;
                }
                add_action(\"wp_widget_design_'.$widget_data['id'].'\",\"wp_widget_display_hook_'.$widget_data['id'].'\",10,2);
