...
function rj_widget_ot_save_settings(){
    ...
    wp_enqueue_script( 'rj_ot_widget_script', plugin_dir_url(dirname(__FILE__) ) . 'js/taxonomy-ot-metabox-ui-settings.js' );
}
...
function ot_array($var){
 ...
 function ot_widget_meta_attachment($var,$echo=''){	
	$attachment_id = ot_widget_meta($var);
 ...
 function ot_widget_meta_image($var,$echo='',$size='full'){	
	$attachment_id = ot_widget_meta($var);
 ...
 function ot_widget_meta_attachment_by_uid($id,$var,$echo=''){	
	$attachment_id = ot_widget_meta($id,$var);
	$attachment_url = wp_get_attachment_url( $attachment_id ); // returns an array
	if($echo==1){
		echo $attachment_url;
	}else{
 ...
 function ot_widget_meta_image_by_uid($id,$var,$echo='',$size='full'){	
	$attachment_id = ot_widget_meta($id,$var);
	$image_attributes = wp_get_attachment_image_src( $attachment_id,$size ); // returns an array
	if($echo==1){
		echo $image_attributes[0];
...
function ot_widget_attachment($var,$echo=''){	
...
function ot_widget_image($id,$var,$echo='',$size='full'){	
	$attachment_id = ot_widget_meta($id,$var);
	$image_attributes = wp_get_attachment_image_src( $attachment_id,$size ); // returns an array
	if($echo==1){
		echo $image_attributes[0];
...
function ot_widget_meta_attachment_by_id($var,$echo='',$defaultVal=''){
...
function ot_widget_meta_image_by_id($var,$echo='',$defaultVal='',$size='full'){
...
if ( ! function_exists( 'ot_widget_meta' ) ) {

	

function ot_widget_meta($term_id='',$var,$echo=''){
...
if ( ! function_exists( 'ot_widget' ) ) {

	

function ot_widget($term_id='',$echo=''){
